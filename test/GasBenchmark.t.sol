...
contract GasBenchmarkTest is Test {
    ...
    function benchmarkGasUsage(string memory file) internal {
        ...
        while (true) {
            ...
            (bool our_result, uint256 our_gasUsed_test) = evaluate(address(huff_verifier), hash, r, s, x, y);
        ...
        logSummaryStatistics(our_gasUsed, "Huff verifier gas usage");
